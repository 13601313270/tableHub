        ...
        <section id="fileList">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td class="fileName">{$httpFileConfig[$file]}<span data-id="{$file}"
                                                                       class="btn btn-default">修改</span></td>
                    <td></td>
                </tr>
                {/if}
                {/foreach}
                <tr>
                    <script>
                        function createPage(dom) {
                            var info = $(dom).parents('tr').find('>td>input');
                            post('mysqlAction.php', {
                                action: 'createPage',
                                fileName: info.eq(0).val(),
                                title: info.eq(1).val(),
                            }, function (data) {
                                //运行完,进行刷新
                    ...
                    <td>
                        <button type="button" class="btn btn-default" onclick="createPage(this)">新增</button>
                    </td>
                </tr>
                </tbody>
            </table>
            ...
            <div class="panel panel-default">
                <ul class="list-group">
                    <li class="list-group-item">
                        ...
                        <div class="btn-group">
                            <button id="githubStateChange" type="button" class="btn btn-default dropdown-toggle"
                        ...
                        <div class="btn-group">
                            <button id="commitlog" type="button" class="btn btn-default dropdown-toggle"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                $('#commitlog').click(function () {
                    ...
                    post('httpAdminMetaAction.php', {
                        ...
                        function getRandomColor() {
                            ...
                            colorBase = colorBase.sort(function () {
...
<style>
    ...
    #showTableColumn {
        position: fixed;
        background-color: rgba(141, 141, 141, 0.48);
        left: 0;
        top: 0;
        width: 100%;
        height: 100%;
