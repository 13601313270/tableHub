//饼状图
function SCATTER(title,XtdLists,valueTdLists){
    this.top = 0;
    this.left = 0;
    this.width = 300;
    this.height = 300;
    ...
    this.dom = $('<div type="SCATTER"><div style="width:100%;height:100%;"></div></div>');
    this.dom.css({
...
SCATTER.prototype = new obj('SCATTER');
chartsInit(SCATTER,'散点图',{
    params:{
        title:{
            title:'标题',
            dataType:'int',
